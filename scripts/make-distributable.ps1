...
#
# The recipient runs agent-deck.bat -> Install, and setup recreates everything
# from source. They supply their OWN Discord bot — nothing of yours travels in
# the zip.
#
# Usage:
...
Write-Host "  agent-deck.bat -> Install." -ForegroundColor Green
